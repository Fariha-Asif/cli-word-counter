...
while (condition2) {
    ...
    if (options.Selection == "Word Count") {
        const answer1 = await inquirer.prompt([
            {
                name: "sentence",
                type: "input",
                message: chalk.red.italic("Kindly write your sentence/paragraph which you want to count:"),
            },
            {
                name: "again",
                type: "confirm",
        ...
        console.log(chalk.green.italic("Your sentence word count is:" + chalk.yellow(words.length)));
    }
    if (options.Selection == "Alphabets count") {
        ...
        console.log(chalk.green.italic("Your sentence alphabet count is:" + chalk.yellow(word.length)));
    }
    if (options.Selection == "Sentence count") {
        const answer2 = await inquirer.prompt([{
                name: "sentence",
                type: "input",
                message: chalk.red.italic("Kindly write your paragraph which you want to count:"),
            }, {
                name: "again",
                type: "confirm",
                message: chalk.red("Do you want to count again?"),
        ...
        console.log(chalk.blue.italic(word));
        console.log(chalk.green.italic("Your sentence count is:" + chalk.yellow(word1)));
    }
